...
function toNewsArticle(item: RecommendedArticleItem): NewsArticle {
  return {
    ...
    image: item.image || "/images/hero-campus.jpg",
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2.5">
                    ...
                    {user?.studentId && (
                      <span className="inline-flex items-center rounded-md border border-primary/20 bg-primary/10 px-2.5 py-0.5 font-mono text-xs font-bold text-primary tracking-wide">
                        ID: {user.studentId}
                      </span>
                    )}
                  </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-md border border-border bg-surface p-5">
                ...
                {!feed?.hasProfile && !loading && (
                  <Link
                    href="/dashboard/profile"
                    id="complete-profile-cta"
                    className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-md bg-primary px-4 py-2.5 text-xs font-bold text-primary-foreground transition-colors hover:bg-navy"
                  >
                ...
                {feed?.hasProfile && !loading && (
                  <Link
                    href="/dashboard/profile"
                    id="edit-profile-cta"
                    className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-md border border-border bg-background px-4 py-2 text-xs font-semibold text-foreground transition-colors hover:border-primary hover:text-primary"
                  >
                    Edit Preferences
                  </Link>
                )}
