        ...
        <div className="w-full max-w-md rounded-xl border border-border bg-card p-5 sm:p-7 shadow-xs">
          ...
          <form className="mt-5 space-y-3.5" onSubmit={(e) => e.preventDefault()}>
            <div>
              ...
              <input id="reset-password" type="password" required placeholder="New password" className="h-10 w-full rounded-md border border-border bg-background px-3 text-sm outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary" />
            </div>
            <div>
              <label htmlFor="reset-confirm" className="meta mb-1 block text-foreground">Confirm password</label>
              <input id="reset-confirm" type="password" required placeholder="Confirm password" className="h-10 w-full rounded-md border border-border bg-background px-3 text-sm outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary" />
            </div>
