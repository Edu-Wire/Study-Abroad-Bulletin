  ...
  return (
    <section className="border-b border-border bg-background">
      <div className="shell py-6 lg:py-8">
        ...
        {/* Edition dateline — thin navy bottom border, navy text */}
        <div className="flex items-center justify-between border-b border-primary pb-2 mb-0">
          <span className="eyebrow font-bold text-primary tracking-widest">{editionDate}</span>
          <span className="eyebrow font-bold text-primary tracking-widest hidden sm:block">Global Edition</span>
        </div>

        {/* Main editorial grid — ~70 / ~30 */}
        <div className="mt-0 grid gap-0 lg:grid-cols-[minmax(0,1fr)_340px] xl:grid-cols-[minmax(0,1fr)_360px]">

          {/* LEFT — Lead story */}
          <div className="min-w-0 lg:pr-8 lg:border-r lg:border-border pt-6">
            <article className="group">
              {/* Category + breaking badge */}
              <div className="flex items-center gap-2 mb-3">
                {lead.breaking && (
                  <span className="eyebrow text-primary-foreground bg-primary px-2 py-0.5">
                    Breaking
                  </span>
                )}
              ...
              {/* HEADLINE */}
              <h1 className="font-display font-extrabold text-foreground leading-[1.02] tracking-[-0.03em] text-[2rem] sm:text-[2.5rem] lg:text-[2.75rem] xl:text-[3rem] mb-3">
              ...
              {/* Meta */}
              <p className="meta text-muted-foreground mb-5">
                {lead.date}
            ...
            <div className="mt-0 grid grid-cols-3 border-t border-border">
              {[
                { value: "1,240", label: "Universities" },
                { value: "860", label: "Scholarships" },
                { value: "120+", label: "Updates / week" },
              ].map(({ value, label }, i) => (
                <div
                  key={label}
                  className={`py-4 px-4 ${i < 2 ? "border-r border-border" : ""}`}
                >
                  <p className="font-display text-[1.75rem] font-extrabold text-foreground sm:text-[2rem] lg:text-[2.5rem] leading-none">
                    {value}
                  </p>
          ...
          {/* RIGHT — Story stack with thumbnails */}
          <div className="min-w-0 lg:pl-8 border-t border-border pt-6 mt-6 lg:mt-0 lg:border-t-0">

            {/* Section heading — navy top rule + navy bold label */}
            <div className="border-t-2 border-primary pt-3 mb-0">
              <p className="eyebrow font-bold text-primary tracking-widest">More Top Stories</p>
            </div>
            <div className="border-b border-border mb-4" />

            <div className="divide-y divide-border">
              {[second, third, fourth, fifth].filter(Boolean).map((article, i) => (
                <article key={article!.id} className="group py-5 first:pt-4">
                  <div className="flex gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h3 className="font-display font-bold text-foreground leading-[1.1] text-[1.0625rem] sm:text-[1.125rem]">
            ...
            {/* Quick Access */}
            <div className="mt-5 border-t-2 border-primary pt-3">
              <p className="eyebrow font-bold text-primary tracking-widest mb-3">Quick Access</p>
              <div className="grid grid-cols-2 gap-0 border border-border">
                {[
                  ...
                  <Link
                    key={label}
                    href={href}
                    className={`group flex items-center justify-between px-3 py-3 text-xs font-semibold text-foreground hover:bg-primary hover:text-primary-foreground transition-colors ${
                  ...
                  >
                    {label}
                    <ArrowRight className="size-3 text-primary group-hover:text-primary-foreground" />
                  </Link>
                ))}
              </div>
            </div>
  ...
  return (
    <div className="border-b border-primary bg-primary">
      <div className="shell flex items-center gap-3 py-2.5">
        ...
        <p className="min-w-0 flex-1 truncate text-sm font-semibold text-primary-foreground">
          {breakingHeadline}
        </p>
        <Link
          href="/news"
          className="eyebrow shrink-0 text-primary-foreground/80 hover:text-primary-foreground transition-colors"
        >
          View Story →
        </Link>
      </div>
    ...
    <section className="border-b border-border bg-surface">
      <div className="shell py-8 lg:py-12">
        <div className="grid gap-0 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3 lg:pr-8 lg:border-r lg:border-border">
            ...
            <h2 className="font-display text-2xl font-extrabold text-foreground sm:text-3xl leading-tight">
              Today&apos;s<br className="hidden lg:block" /> Briefing
            </h2>
          ...
          <div className="mt-6 lg:mt-0 lg:col-span-9 lg:pl-8">
            <div className="divide-y divide-border">
              {categorised.map((article, i) => (
                <article key={article.id} className="group grid grid-cols-[2.5rem_minmax(0,1fr)] gap-4 py-4 first:pt-0 last:pb-0">
                  {/* Large number */}
                  <span className="font-display text-3xl font-extrabold text-border leading-none tabular-nums mt-0.5 select-none">
  ...
  return (
    <section className="border-b border-border bg-background">
      <div className="shell py-8 lg:py-12">
        ...
        <div className="mt-6 grid gap-0 lg:grid-cols-12">

          {/* Featured two destinations */}
          ...
          <div className="mt-6 lg:mt-0 lg:col-span-4 lg:pl-8">
            ...
            <div className="divide-y divide-border">
              {countries.slice(2).map((country) => (
                <Link
                  ...
                  className="group flex items-center justify-between py-3 hover:text-primary transition-colors"
                >
        ...
        {highlightedScholarship && (
          <div className="mt-6 grid gap-0 lg:grid-cols-12">
            ...
            <div className="lg:col-span-4 lg:pr-8 lg:border-r lg:border-border">
              <div className="border-t-2 border-primary pt-5 pb-5">
                <span className="eyebrow text-primary border border-primary/20 bg-primary-soft px-2 py-0.5">
                ...
                <Link
                  ...
                  className="mt-4 inline-flex items-center gap-2 bg-primary px-4 py-2.5 eyebrow text-primary-foreground hover:opacity-90 transition-opacity"
                >
            ...
            <div className="mt-6 lg:col-span-8 lg:mt-0 lg:pl-8 border-t border-border pt-6 lg:pt-0 lg:border-t-0">
              <div className="divide-y divide-border">
                {featured.slice(1).map((s) => (
                  <article key={s.id} className="py-4 group">
        ...
        {closingSoon.length > 0 && (
          <div className="mt-8">
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="eyebrow text-primary shrink-0">Closing Soon — Deadlines Within 14 Days</span>
              <div className="section-rule flex-1" />
            </div>
  ...
  return (
    <section className="border-b border-border bg-background">
      <div className="shell py-8 lg:py-12">
        ...
        <div className="mt-6 grid gap-0 lg:grid-cols-12">
          {/* Lead visa story */}
          <div className="lg:col-span-5 lg:pr-8 lg:border-r lg:border-border">
            {visaUpdates[0] && (
              <article className="group border-t-2 border-primary pt-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {visaUpdates[0].urgent && (
                    <span className="eyebrow text-primary-foreground bg-primary px-2 py-0.5">Urgent</span>
                  )}
                </div>
          ...
          <div className="mt-6 lg:mt-0 lg:col-span-7 lg:pl-8 border-t border-border pt-6 lg:pt-0 lg:border-t-0">
            <div className="divide-y divide-border">
              {visaUpdates.slice(1).map((update) => (
                <article key={update.id} className="group grid grid-cols-[auto_minmax(0,1fr)] gap-4 py-4">
    ...
    <section className="border-b border-border bg-surface">
      <div className="shell py-8 lg:py-12">
        ...
        <div className="mt-6 grid gap-0 lg:grid-cols-12">
          ...
          {featured && (
            <div className="lg:col-span-4 lg:pr-8 lg:border-r lg:border-border">
              <article className="group border-t-2 border-foreground pt-4 transition-colors hover:border-primary">
          ...
          {/* Supporting guides — compact rows */}
          <div className="mt-6 lg:mt-0 lg:col-span-8 lg:pl-8 border-t border-border pt-6 lg:pt-0 lg:border-t-0">
            <div className="grid gap-0 sm:grid-cols-2">
              {supporting.slice(0, 6).map((guide, i) => (
                <article
                  key={guide.id}
                  className={`group border-t border-border py-4 pr-0 sm:pr-6 transition-colors ${
            ...
            <div className="mt-4">
              {deadlines.map((deadline) => {
                ...
                return (
                  <article
                    key={deadline.id}
                    className="grid grid-cols-[3rem_1px_minmax(0,1fr)_auto] items-start gap-3 border-b border-border py-4 sm:grid-cols-[4rem_1px_minmax(0,1fr)_auto]"
                  >
                    {/* Date block */}
                    <div className="text-center">
                      <p className={`font-display text-3xl font-extrabold leading-none ${urgent ? "text-primary" : "text-foreground"}`}>
                        {dayStr}
                      </p>
                    ...
                    {/* Days left */}
                    <div className="text-right shrink-0">
                      <p className={`font-display text-xl font-bold ${urgent ? "text-primary" : "text-foreground"}`}>
                        {deadline.daysLeft}
                      </p>
            ...
            <div className="mt-6 divide-y divide-border">
              {[
                ...
                >
                  ...
                  <ArrowRight className="size-4 opacity-0 group-hover:opacity-100 transition-opacity shrink-0 ml-2" />
                </Link>
              ))}
            </div>
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-4 lg:text-right">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-primary px-6 py-3 eyebrow text-primary-foreground hover:opacity-90 transition-opacity"
            >
      ...
      <div className="shell py-8 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-4 lg:text-right">
            <Link
              href="/consultants"
              className="inline-flex items-center gap-2 border border-foreground bg-background px-6 py-3 eyebrow text-foreground hover:border-primary hover:text-primary transition-colors"
            >
