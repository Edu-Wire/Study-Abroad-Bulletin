...
export function ArticleFormModal({
  ...
  const inputClass =
    "w-full h-10 px-3.5 bg-slate-50/80 border border-slate-200/90 rounded-xl text-slate-900 text-xs focus:outline-none focus:border-[#1769E0] focus:bg-white transition-colors placeholder-slate-400";
  const labelClass =
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#071A33]/60 backdrop-blur-xs">
      <div className="w-full max-w-2xl bg-white rounded-[28px] shadow-2xl border border-slate-200/90 flex flex-col max-h-[92vh] overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4.5 border-b border-slate-200/80 shrink-0">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-2xl bg-blue-50 text-[#1769E0] border border-blue-100 flex items-center justify-center shrink-0">
            ...
            <div className="flex gap-2">
              ...
              {mode === "create" && !slugAutoMode && (
                <button
                  ...
                  className="h-10 px-3.5 text-[11px] font-semibold bg-blue-50 text-[#1769E0] hover:bg-blue-100 rounded-xl transition-colors cursor-pointer shrink-0"
                >
                  Auto
                </button>
              )}
        ...
        {/* Modal Footer */}
        <div className="px-6 py-4 border-t border-slate-200/80 bg-slate-50/70 shrink-0 flex items-center justify-between gap-3 rounded-b-[28px]">
          ...
          <div className="flex items-center gap-2.5 ml-auto">
            <button
              type="button"
              onClick={onClose}
              className="px-5 py-2.5 text-xs font-semibold text-slate-700 bg-white hover:bg-slate-100 border border-slate-200 rounded-full transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
              ...
              form="article-form"
              disabled={submitting}
              className="inline-flex items-center gap-1.5 px-5 py-2.5 text-xs font-semibold text-white bg-[#1769E0] hover:bg-[#1357bd] rounded-full transition-all cursor-pointer disabled:opacity-50 shadow-2xs hover:shadow-xs"
            >
